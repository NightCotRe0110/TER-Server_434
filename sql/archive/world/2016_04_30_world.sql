...
(@ENTRY,0,3,0,8,0,100,0,90679,0,5000,5000,33,28495,0,0,0,0,0,7,0,0,0,0,0,0,0,"Quest Kredit on Spell Hit");

UPDATE `quest_template` SET `RequiredNpcOrGo1` = 48187, `RequiredSpellCast1` = 90679 WHERE `Id` = 28495;
UPDATE `quest_template` SET `RequiredSourceItemId4` = 0, `RequiredSourceItemCount4` = 0, `RequiredSpellCast1` = 0 WHERE `Id` = 28495;
...
UPDATE `quest_template` SET `RequiredSpellCast1` = 89821 WHERE `Id` = 28331;

SET @ENTRY := 48269;
UPDATE `creature_template` SET `AIName`="SmartAI" WHERE `entry`=@ENTRY;
DELETE FROM `smart_scripts` WHERE `entryorguid`=@ENTRY AND `source_type`=0;
INSERT INTO `smart_scripts` (`entryorguid`,`source_type`,`id`,`link`,`event_type`,`event_phase_mask`,`event_chance`,`event_flags`,`event_param1`,`event_param2`,`event_param3`,`event_param4`,`action_type`,`action_param1`,`action_param2`,`action_param3`,`action_param4`,`action_param5`,`action_param6`,`target_type`,`target_param1`,`target_param2`,`target_param3`,`target_x`,`target_y`,`target_z`,`target_o`,`comment`) VALUES
(@ENTRY,0,0,0,8,0,100,0,89821,0,5000,5000,33,48269,0,0,0,0,0,7,0,0,0,0,0,0,0,"Quest Kredit on Spell Hit");

UPDATE `quest_template` SET `RequiredNpcOrGo1` = 48272, `RequiredSpellCast1` = 0 WHERE `Id` = 28331;
