...
void World::LoadConfigSettings(bool reload)
{
	...
	m_bool_configs[CONFIG_NO_CAST_TIME] = ConfigMgr::GetBoolDefault("TER-Server.NoCastTime", false);

	m_bool_configs[CONFIG_NO_COOLDOWN] = ConfigMgr::GetBoolDefault("TER-Server.NoCooldown", false);

	m_bool_configs[CONFIG_HURT_IN_REAL_TIME] = ConfigMgr::GetBoolDefault("TER-Server.HurtInRealTime", false);

	

		m_float_configs[CONFIG_ATTACKSPEED_PLAYER] = ConfigMgr::GetFloatDefault("TER-Server.AttackSpeedForPlayer", 1.0f);

	m_float_configs[CONFIG_ATTACKSPEED_ALL] = ConfigMgr::GetFloatDefault("TER-Server.AttackSpeedForMobs", 1.0f);

	m_bool_configs[CONFIG_FAST_FISHING] = ConfigMgr::GetBoolDefault("TER-Server.Fishing.time-off", false);
